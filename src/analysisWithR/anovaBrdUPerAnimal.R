...
numAnimals <- 4
path2read20mc <- "D:/Pedro/AgingDots/resultsByAnimal/NSCs BrdU/clusterDistance/3m/statistic/20mc/"
path2read50mc <- "D:/Pedro/AgingDots/resultsByAnimal/NSCs BrdU/clusterDistance/3m/statistic/50mc/"
...
for(i in 1:length(multFactors)){
  ...
  for(j in 1:numAnimals){
    ...
    if(i<numAnimals){
      ...
      write.table(out, file =paste(path2read20mc,"animal ",j,"/statisticAnimal_", j,"_clusterDistance20mc_x", multFactors[i] , ".txt",sep=""))
    ...
    out<-capture.output(dataStatisticPerAnimal)
    write.table(out, file =paste(path2read50mc,"animal ",j,"/statisticAnimal_", j,"_clusterDistance50mc_x", multFactors[i] , ".txt",sep=""))
  ...
  if(i<4){
    ...
    write.table(out, file =paste(path2read20mc,"clusterDistance20mc_x", multFactors[i] , ".txt",sep=""))
  ...
  write.table(out, file =paste(path2read50mc,"clusterDistance50mc_x", multFactors[i] , ".txt",sep=""))
